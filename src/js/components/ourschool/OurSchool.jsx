        ...
        <div className="head">
          ...
          <div className="col1">
            ...
            <div className="mission">
              <h2>Our Mission</h2>
              <div className="box" />
              <p>We aim develop individual potential and self-worth through stimulating and positive relationships
          ...
          <div className="col2 board">
            ...
            <h5>AMMAR ALVI</h5>
            <p>Principal / Head of Senior Classes Mechanical Engineering <br />
              <p className="honor">Honors:
              </p>
              UET,Lahore <br />
            ...
            <h5>FREEHA ALVI</h5>
            <p>Head of Middle Classes Mechanical Engineering <br />
              <p className="honor">Honors:
              </p>
              UET,Lahore <br />
              MBA HR - IBA Punjab University, Lahore <br />
